...
type Statistic struct {
	...
	// current period
	CurrentPeriod *PeriodObject `json:"currentPeriod,omitempty"`

	// organizational unit
	OrganizationalUnit *ModelReference `json:"organizationalUnit,omitempty"`

	// previous period
	PreviousPeriod *PeriodObject `json:"previousPeriod,omitempty"`
}
...
func (m *Statistic) validateCurrentPeriod(formats strfmt.Registry) error {
...
func (m *Statistic) validateOrganizationalUnit(formats strfmt.Registry) error {
...
func (m *Statistic) validatePreviousPeriod(formats strfmt.Registry) error {
