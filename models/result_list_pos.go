...
// ResultListPos result list pos
//
// swagger:model ResultListPos
type ResultListPos struct {
...
// Validate validates this result list pos
func (m *ResultListPos) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResultListPos) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *ResultListPos) validateLinks(formats strfmt.Registry) error {

	return nil
}

func (m *ResultListPos) validatePagesTotal(formats strfmt.Registry) error {
...
func (m *ResultListPos) validateResults(formats strfmt.Registry) error {
...
func (m *ResultListPos) validateResultsOfPage(formats strfmt.Registry) error {
...
func (m *ResultListPos) validateResultsTotal(formats strfmt.Registry) error {
...
func (m *ResultListPos) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResultListPos) UnmarshalBinary(b []byte) error {
	var res ResultListPos
