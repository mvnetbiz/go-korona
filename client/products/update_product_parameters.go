...
type UpdateProductParams struct {
	...
	/*Body
	  the properties to update of the product
...
// WithKoronaAccountID adds the koronaAccountID to the update product params
func (o *UpdateProductParams) WithKoronaAccountID(koronaAccountID string) *UpdateProductParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the update product params
func (o *UpdateProductParams) SetKoronaAccountID(koronaAccountID string) {
	o.KoronaAccountID = koronaAccountID
}

// WithProductID adds the productID to the update product params
func (o *UpdateProductParams) WithProductID(productID string) *UpdateProductParams {
	o.SetProductID(productID)
	return o
}

// SetProductID adds the productId to the update product params
func (o *UpdateProductParams) SetProductID(productID string) {
