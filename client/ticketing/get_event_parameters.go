...
// WithKoronaAccountID adds the koronaAccountID to the get event params
func (o *GetEventParams) WithKoronaAccountID(koronaAccountID string) *GetEventParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the get event params
func (o *GetEventParams) SetKoronaAccountID(koronaAccountID string) {
