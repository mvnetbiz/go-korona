...
// WithKoronaAccountID adds the koronaAccountID to the get image params
func (o *GetImageParams) WithKoronaAccountID(koronaAccountID string) *GetImageParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the get image params
func (o *GetImageParams) SetKoronaAccountID(koronaAccountID string) {
