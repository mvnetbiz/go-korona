...
for the update tags operation typically these are written to a http.Request
*/
...
// WithBody adds the body to the update tags params
func (o *UpdateTagsParams) WithBody(body []*models.Tag) *UpdateTagsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update tags params
func (o *UpdateTagsParams) SetBody(body []*models.Tag) {
	o.Body = body
}

// WithKoronaAccountID adds the koronaAccountID to the update tags params
func (o *UpdateTagsParams) WithKoronaAccountID(koronaAccountID string) *UpdateTagsParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the update tags params
func (o *UpdateTagsParams) SetKoronaAccountID(koronaAccountID string) {
