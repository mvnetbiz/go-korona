...
// WithKoronaAccountID adds the koronaAccountID to the delete tag params
func (o *DeleteTagParams) WithKoronaAccountID(koronaAccountID string) *DeleteTagParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the delete tag params
func (o *DeleteTagParams) SetKoronaAccountID(koronaAccountID string) {
	o.KoronaAccountID = koronaAccountID
}

// WithTagID adds the tagID to the delete tag params
func (o *DeleteTagParams) WithTagID(tagID string) *DeleteTagParams {
	o.SetTagID(tagID)
	return o
}

// SetTagID adds the tagId to the delete tag params
func (o *DeleteTagParams) SetTagID(tagID string) {
	o.TagID = tagID
}
