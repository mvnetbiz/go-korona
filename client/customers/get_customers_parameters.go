...
// WithIncludeDeleted adds the includeDeleted to the get customers params
func (o *GetCustomersParams) WithIncludeDeleted(includeDeleted *bool) *GetCustomersParams {
	o.SetIncludeDeleted(includeDeleted)
	return o
}

// SetIncludeDeleted adds the includeDeleted to the get customers params
func (o *GetCustomersParams) SetIncludeDeleted(includeDeleted *bool) {
	o.IncludeDeleted = includeDeleted
}

// WithKoronaAccountID adds the koronaAccountID to the get customers params
func (o *GetCustomersParams) WithKoronaAccountID(koronaAccountID string) *GetCustomersParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the get customers params
func (o *GetCustomersParams) SetKoronaAccountID(koronaAccountID string) {
...
func (o *GetCustomersParams) WithPage(page *int32) *GetCustomersParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get customers params
func (o *GetCustomersParams) SetPage(page *int32) {
	o.Page = page
}

// WithRevision adds the revision to the get customers params
func (o *GetCustomersParams) WithRevision(revision *int64) *GetCustomersParams {
	o.SetRevision(revision)
	return o
}

// SetRevision adds the revision to the get customers params
func (o *GetCustomersParams) SetRevision(revision *int64) {
	o.Revision = revision
}

// WithSize adds the size to the get customers params
func (o *GetCustomersParams) WithSize(size *int32) *GetCustomersParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the get customers params
func (o *GetCustomersParams) SetSize(size *int32) {
	o.Size = size
}

// WithSort adds the sort to the get customers params
func (o *GetCustomersParams) WithSort(sort *string) *GetCustomersParams {
	o.SetSort(sort)
	return o
}

// SetSort adds the sort to the get customers params
func (o *GetCustomersParams) SetSort(sort *string) {
	o.Sort = sort
}
