...
// WithIncludeDeleted adds the includeDeleted to the get accounts params
func (o *GetAccountsParams) WithIncludeDeleted(includeDeleted *bool) *GetAccountsParams {
	o.SetIncludeDeleted(includeDeleted)
	return o
}

// SetIncludeDeleted adds the includeDeleted to the get accounts params
func (o *GetAccountsParams) SetIncludeDeleted(includeDeleted *bool) {
	o.IncludeDeleted = includeDeleted
}

// WithKoronaAccountID adds the koronaAccountID to the get accounts params
func (o *GetAccountsParams) WithKoronaAccountID(koronaAccountID string) *GetAccountsParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the get accounts params
func (o *GetAccountsParams) SetKoronaAccountID(koronaAccountID string) {
	o.KoronaAccountID = koronaAccountID
}

// WithPage adds the page to the get accounts params
func (o *GetAccountsParams) WithPage(page *int32) *GetAccountsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get accounts params
func (o *GetAccountsParams) SetPage(page *int32) {
	o.Page = page
}

// WithRevision adds the revision to the get accounts params
func (o *GetAccountsParams) WithRevision(revision *int64) *GetAccountsParams {
	o.SetRevision(revision)
	return o
}

// SetRevision adds the revision to the get accounts params
func (o *GetAccountsParams) SetRevision(revision *int64) {
	o.Revision = revision
}

// WithSize adds the size to the get accounts params
func (o *GetAccountsParams) WithSize(size *int32) *GetAccountsParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the get accounts params
func (o *GetAccountsParams) SetSize(size *int32) {
	o.Size = size
}

// WithSort adds the sort to the get accounts params
func (o *GetAccountsParams) WithSort(sort *string) *GetAccountsParams {
	o.SetSort(sort)
	return o
}

// SetSort adds the sort to the get accounts params
func (o *GetAccountsParams) SetSort(sort *string) {
	o.Sort = sort
}
