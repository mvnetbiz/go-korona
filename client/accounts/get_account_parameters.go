...
// WithKoronaAccountID adds the koronaAccountID to the get account params
func (o *GetAccountParams) WithKoronaAccountID(koronaAccountID string) *GetAccountParams {
	o.SetKoronaAccountID(koronaAccountID)
	return o
}

// SetKoronaAccountID adds the koronaAccountId to the get account params
func (o *GetAccountParams) SetKoronaAccountID(koronaAccountID string) {
